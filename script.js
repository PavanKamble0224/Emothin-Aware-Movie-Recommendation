...
function startVoice() {
    ...
    recognition.onresult = (e) => {
        ...
        if (text.includes("action")) getMovies("popular");
        else if (text.includes("romantic")) getMovies("top_rated");
        else if (text.includes("new")) getMovies("upcoming");
        else alert("Try: action, romantic, new");
    };
